---
title: iOS App 签名的原理([抄袭的，有问题请联系](http://wereadteam.github.io/2017/03/13/Signature/))
date: 2019-06-03 12:07:12
tags: iOS App 签名的原理
categories: IOS
toc: true
---
...
若对数字 d 是怎样计算出来的感兴趣，可以详读这两篇文章：[RSA 算法原理（一）（二）](http://www.ruanyifeng.com/blog/2013/06/rsa_algorithm_part_one.html)
...
1. Entitlements：包含了 App 权限开关列表。
2. CertificateSigningRequest：本地公钥。
...
## mobileprovision 格式调研(这点是自己的)

![mobileprovision](ios_sign/sign5.png)
