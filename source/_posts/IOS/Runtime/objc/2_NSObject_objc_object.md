...
从定义可以看出，这只用一个成员，但是也类似位域，不同的位有不同的作用，bit不像isa使用位域定义，他使用移位定义，如下:
...
![objc-method-lldb-print-before-realize](2_NSObject_objc_object/objc-method-lldb-print-before-realize.png)
